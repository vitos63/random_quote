...
urlpatterns = [
    ...
    path('author-quotes/<slug:author>/', AuthorQuotesAPIView.as_view(), name='author_quotes'),
    path('category-quotes/<slug:category>/', CategoryQuotesAPIView.as_view(), name='category_quotes'),
