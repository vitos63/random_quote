...
class APITestCase(TestCase):
    def setUp(self):
        ...
        self.quote = Quote.objects.create(
            quote="Test Quote", author=self.author, status="Published"
        )
    ...
    def test_create_quote_author_error_api_view(self):
        ...
        data = {"quote": "New Quote", "new_categories": "New_cat_1, New_cat_2"}
        ...
        self.assertTrue(
            ...
            "Вы должны выбрать уже существующего автора или написать своего",
        )

    def test_create_quote_categories_error_api_view(self):

        data = {"quote": "New Quote", "new_author": "New Author"}
        ...
        self.assertTrue(
            ...
            "Вы должны выбрать из уже существующих категорий или написать свои",
        )
