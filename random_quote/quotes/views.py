...
class CategoriesView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if search_field:
            context["categories"] = Category.objects.with_published_quotes().filter(
